...
public class Step {
    ...
    public void addContent(String line) { content.add(line); }
    public List<String> getDeclarations() { return declarations; }
    public void addDeclaration(String declaration) { declarations.add(declaration); }
    public void addAllDeclarations(List<String> declarations) { this.declarations.addAll(declarations); }
